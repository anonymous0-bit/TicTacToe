...
def CellButton(frame):
    b=Button(frame,padx=1,bg="#00F000",width=3,text=" ",font=('algerian',60,'bold'),relief="sunken",bd=5)
    return b
...
Label(root,text="First Player Name[X]",bg="#800080",fg="white",font=("Arial",15,"bold")).place(x=550,y=20)
#textbox for first player
Entry(root,font=("Arial",15,"bold"),textvariable=firstPlayer).place(x=550,y=55)
#label for second player
Label(root,text="Second Player Name[O]",bg="#000000",fg="white",font=("Arial",15,"bold")).place(x=550,y=90)
